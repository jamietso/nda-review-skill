...
- Do **NOT** constitute legal advice or create an attorney-client relationship
...
- Must be reviewed and validated by a licensed attorney before making any legal decisions or signing any legal documents

**Always consult with a qualified legal professional** before entering into, modifying, or taking any action based on legal documents or agreements. Laws vary significantly by jurisdiction and individual circumstances, and only a licensed attorney familiar with your specific situation can provide appropriate legal guidance.

By using this skill, you acknowledge that:
1. You understand this is an AI-generated analysis tool, not legal counsel
2. Any outputs must be reviewed by qualified legal professionals
3. You will not rely solely on AI-generated content for legal decisions
4. You assume all responsibility for decisions made based on or related to the use of this tool
